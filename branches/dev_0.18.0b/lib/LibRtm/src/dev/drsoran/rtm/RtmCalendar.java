...
public final class RtmCalendar
{
   ...
   private RtmCalendar( TimeZone timezone )
   {
   ...
   private RtmCalendar( Calendar calendar )
   {
      impl = calendar;
   }
   ...
   @Override
   public RtmCalendar clone()
   {
      final RtmCalendar clone = new RtmCalendar( (Calendar) impl.clone() );
   ...
   public final static RtmCalendar getInstance()
   {
      return new RtmCalendar( TimeZone.getDefault() );
   }
   
   
   
   public final static RtmCalendar getDatelessAndTimelessInstance()
   {
      final RtmCalendar cal = getInstance();
   ...
   public final static RtmCalendar clone( RtmCalendar other )
   {
      final RtmCalendar calClone = getInstance();
   ...
   public final static RtmCalendar getUTCInstance()
   {
      return new RtmCalendar( TimeZone.getTimeZone( "UTC" ) );
   }
   ...
   {
      if ( object instanceof RtmCalendar )
      {
         return ( (RtmCalendar) object ).impl;
      }
