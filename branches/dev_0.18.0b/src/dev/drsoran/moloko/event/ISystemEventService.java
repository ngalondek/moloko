...
public interface ISystemEventService
{
   ...
   void unregisterOnTimeChangedListener( IOnTimeChangedListener listener );
   
   
   
   void registerOnNetworkStatusChangedListener( IOnNetworkStatusChangedListener listener );
