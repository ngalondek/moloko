...
public class SyncRtmTaskList
{
   ...
   private static final Comparator< RtmTaskSeries > LESS_RTM_ID = new Comparator< RtmTaskSeries >()

   {
      public int compare( RtmTaskSeries object1, RtmTaskSeries object2 )
      {
         return object1.getRtmId().compareTo( object2.getRtmId() );
      }
   };
   ...
   public SyncRtmTaskList( List< RtmTaskSeries > taskSeries )
   {
      ...
      Collections.sort( series, LESS_RTM_ID );
   }
   ...
   public List< InSyncRtmTaskSeries > getInSyncTasksSeries()
   {
      ...
      GetMode.SORTED.perform( res, InSyncRtmTaskSeries.LESS_RTM_ID );
   ...
   public List< OutSyncTask > getOutSyncTasks()
   {
      ...
      GetMode.SORTED.perform( res, OutSyncTask.LESS_RTM_ID );
