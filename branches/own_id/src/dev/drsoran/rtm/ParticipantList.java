         ...
         IContentProviderSyncable< ParticipantList >, Parcelable
{
   ...
   public ParticipantList( String rtmTaskSeriesId )
   {
   ...
   public ParticipantList( String rtmTaskSeriesId, Element elt )
   {
      this.rtmTaskSeriesId = rtmTaskSeriesId;
      ...
      for ( Element contact : contacts )
      {
         ...
         if ( !TextUtils.isEmpty( contactId ) && !TextUtils.isEmpty( fullname )
            ...
            this.participants.add( new Participant( rtmTaskSeriesId,
                                                    contactId,
                                                    fullname,
                                                    username ) );
         else
