...
package dev.drsoran.moloko.state;
...
public class AnnotatedConfigurationSupport
{
   ...
   public void onAttach( SystemContext context )
   {
   ...
   public void onAttach( SystemContext context, Bundle savedInstanceState )
   {
   ...
   public Bundle getDefaultInstanceState( Object instance )
   {
      ...
      if ( registeredInstances != null )
      {
         ...
         for ( Pair< Field, InstanceState > annotatedField : annotatedFields )
         {
            Pair< String, Object > defaultValueWithKey = null;
            
            if ( !annotatedField.second.defaultValue()
   ...
   private Object getInstanceFieldValue( Object instance, Field field )
   {
      ...
      {
         context.Log().e( getClass(), Strings.EMPTY_STRING, e );
         throw e;
      }
      catch ( IllegalAccessException e )
      {
