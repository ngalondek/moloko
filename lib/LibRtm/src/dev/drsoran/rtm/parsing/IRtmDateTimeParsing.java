...
public interface IRtmDateTimeParsing
{
   RtmCalendar parseTime( String time ) throws GrammarException;
   
   
   
   RtmCalendar parseDateTime( String dateAndTime ) throws GrammarException;
   ...
   ParseDateWithinReturn parseDateWithin( String range ) throws GrammarException;
