...
public class DateTimeParsingTest_de extends DateTimeParsingTestBase
{
   ...
   {
      final IDateParser dateParser = new DateParserImpl();
      dateParser.setDateFormatter( getDateFormatContext() );
   ...
   public void date_next_weekday_time()
   {
      ...
      final MolokoCalendar now = getDateParserCalendar();
   ...
   {
      final MolokoCalendar end = getDateParserCalendar();
