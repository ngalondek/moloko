...
import dev.drsoran.rtm.sync.RtmSyncDriver;
import dev.drsoran.rtm.sync.RtmSyncResult;
import dev.drsoran.rtm.sync.SyncTime;


public class RtmSyncDriverFixture
{
   @Test
   public void testRtmSyncDriver()
   {
      new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
   ...
   public void testPerformIncomingSync_Success() throws RtmServiceException
   {
      ...
      final RtmSyncDriver syncDriver = new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
                                                          EasyMock.createNiceMock( IRtmContentEditService.class ),
                                                          handlerFactory,
                                                          timelineFactory );
      
      syncDriver.performIncomingSync( syncPartner,
                                      new SyncTime( TestConstants.NOW,
                                                    TestConstants.NEVER ) );
   ...
   @Test( expected = IllegalArgumentException.class )
   public void testPerformIncomingSync_NullSyncPartner() throws RtmServiceException
   {
      new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
                         EasyMock.createNiceMock( IRtmContentEditService.class ),
                         EasyMock.createNiceMock( IRtmSyncHandlerFactory.class ),
   ...
   public void testPerformIncomingSync_NullSyncTime() throws RtmServiceException
   {
      new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
                         EasyMock.createNiceMock( IRtmContentEditService.class ),
                         EasyMock.createNiceMock( IRtmSyncHandlerFactory.class ),
                         EasyMock.createNiceMock( IRtmTimelineFactory.class ) ).performIncomingSync( EasyMock.createNiceMock( IRtmSyncPartner.class ),
                                                                                                     null );
   }
   ...
   public void testPerformOutgoingSync_Success() throws RtmServiceException
   {
      ...
      syncDriver.performOutgoingSync( syncPartner,
                                      new SyncTime( TestConstants.NEVER,
                                                    TestConstants.NOW ) );
   ...
   @Test( expected = IllegalArgumentException.class )
   public void testPerformOutgoingSync_NullSyncPartner() throws RtmServiceException
   {
      new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
                         EasyMock.createNiceMock( IRtmContentEditService.class ),
                         EasyMock.createNiceMock( IRtmSyncHandlerFactory.class ),
   ...
   public void testPerformOutgoingSync_NullSyncTime() throws RtmServiceException
   {
      new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
                         EasyMock.createNiceMock( IRtmContentEditService.class ),
                         EasyMock.createNiceMock( IRtmSyncHandlerFactory.class ),
                         EasyMock.createNiceMock( IRtmTimelineFactory.class ) ).performOutgoingSync( EasyMock.createNiceMock( IRtmSyncPartner.class ),
                                                                                                     null );
   }
   ...
   public void testPerformFullSync_Success() throws RtmServiceException
   {
      ...
      final RtmSyncDriver syncDriver = new RtmSyncDriver( contentRepository,
                                                          contentEditService,
                                                          handlerFactory,
                                                          timelineFactory );
      
      syncDriver.performFullSync( syncPartner,
                                  new SyncTime( TestConstants.NOW,
                                                TestConstants.LATER ) );
   ...
   @Test( expected = IllegalArgumentException.class )
   public void testPerformFullSync_NullSyncPartner() throws RtmServiceException
   {
      new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
                         EasyMock.createNiceMock( IRtmContentEditService.class ),
                         EasyMock.createNiceMock( IRtmSyncHandlerFactory.class ),
   ...
   public void testPerformFullSync_NullSyncTime() throws RtmServiceException
   {
      new RtmSyncDriver( EasyMock.createNiceMock( IRtmContentRepository.class ),
                         EasyMock.createNiceMock( IRtmContentEditService.class ),
                         EasyMock.createNiceMock( IRtmSyncHandlerFactory.class ),
                         EasyMock.createNiceMock( IRtmTimelineFactory.class ) ).performFullSync( EasyMock.createNiceMock( IRtmSyncPartner.class ),
                                                                                                 null );
   }
}
