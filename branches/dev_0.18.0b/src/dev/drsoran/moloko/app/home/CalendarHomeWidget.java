...
public class CalendarHomeWidget extends AsyncLoadingCounterHomeWidget
{
   ...
   public CalendarHomeWidget( Context context, int type, int textResId )
   {
      super( context, R.layout.home_activity_drawer_item_with_icon );
   ...
   protected void initializeNonLoadables( View view )
   {
      ...
      // TODO: setCalendarDayInWidget( view );
   }
   ...
   public Intent getIntent()
   {
      ...
      final String title = getUiContext().getString( ( ( type == TODAY )
      ...
      return Intents.createSmartFilterIntent( getUiContext(), filter, title );
   }
