...
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.DateIn_X_YMWDContext;
...
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.DateOnContext;
...
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.HmsSeparatedTimeContext;
...
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.ParseDateContext;
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.ParseDateTimeContext;
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.ParseDateWithinContext;
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.ParseTimeContext;
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.ParseTimeEstimateContext;
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.SeparatedTimeContext;
...
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParser.TodayContext;
...
import dev.drsoran.rtm.parsing.grammar.antlr.datetime.DateTimeParserVisitor;


public class RtmLikeDateTimeEvaluator implements DateTimeParserVisitor< Void >
{
   private final DefaultDateTimeEvaluator decorated;
   ...
   public RtmLikeDateTimeEvaluator( DefaultDateTimeEvaluator decorated,
   ...
   public Void visitParseDateTime( ParseDateTimeContext ctx )
   {
      ...
      {
         final RtmCalendar now = calendarProvider.getNow();
         if ( cal.before( now ) )
         {
   ...
   public Void visitDateOnWeekday( DateOnWeekdayContext ctx )
   {
      ...
      final RtmCalendar now = calendarProvider.getNow();
      final RtmCalendar cal = decorated.getCalendar();
