...
/**
 * @brief If a tasks lists gets deleted, move all tasks of the list to to the Inbox
 */
class UpdateTasksFromDeletedListTrigger extends AbstractTrigger
{
   public UpdateTasksFromDeletedListTrigger()
   {
      super( RtmTasksListsTable.TABLE_NAME + "_update_tasks_deleted_list" );
   }
