...
public class MolokoModelElementFactory implements IModelElementFactory
{
   private final Map< Class< ? >, IFactoryMethod< ? > > factoryMethodLookUp = new HashMap< Class< ? >, IFactoryMethod< ? > >();
   
   
   
   public MolokoModelElementFactory()
   {
      ...
      factoryMethodLookUp.put( Settings.class, new RtmSettingsFactoryMethod() );
            ...
            IFactoryMethod< Settings >
   {
      ...
      {
         return new Settings( c.getLong( SettingsColumns.SYNC_TIMESTAMP_IDX ),
                              c.getString( SettingsColumns.TIMEZONE_IDX ),
                              c.getInt( SettingsColumns.DATEFORMAT_IDX ),
                              c.getInt( SettingsColumns.TIMEFORMAT_IDX ),
                              CursorUtils.getOptLong( c,
                                                      SettingsColumns.DEFAULTLIST_ID_IDX,
                                                      Constants.NO_ID ),
                              c.getString( SettingsColumns.LANGUAGE_IDX ) );
      }
   }
