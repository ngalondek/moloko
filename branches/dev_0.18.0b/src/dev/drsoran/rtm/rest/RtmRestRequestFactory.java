...
public class RtmRestRequestFactory implements IRtmRequestFactory
{
   ...
   @Override
   public IRtmRequest createRequest( String rtmMethod,
                                     RtmRequestUriBuilder urlBuilder )
   {
      urlBuilder.setServiceUrl( REST_SERVICE_URL_POSTFIX );
      return new RtmRestRequest( rtmMethod, urlBuilder );
   }
}
