...
public final class Intents
{
                                                    ...
                                                    String filter )
   {
      ...
      if ( client != null )
      {
         final RtmList rtmList = RtmListsProviderPart.getList( client, rtmId );
         client.release();
         
         if ( rtmList != null )
         {
            return createOpenListIntent( context, rtmList.getId(), filter );
         }
      }
   ...
   public final static Intent createEditTaskIntent( Context context, long taskId )
   {
                                                             ...
                                                             long[] taskIds )
   {
      ...
      intent.putExtra( EditMultipleTasksActivity.TASK_IDS, taskIds );
