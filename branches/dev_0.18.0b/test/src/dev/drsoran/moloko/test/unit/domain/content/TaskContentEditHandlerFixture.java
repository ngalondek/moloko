...
public class TaskContentEditHandlerFixture extends MolokoRoboTestCase
{
   ...
   public void testInsertElement()
   {
      ...
      final Task task = new Task( 1L, NOW, NOW, "Task", 100L, "List" );
      
      final ContentResolver contentResolver = EasyMock.createStrictMock( ContentResolver.class );
      EasyMock.expect( contentResolver.insert( EasyMock.eq( ContentUris.TASKS_CONTENT_URI ),
      ...
      EasyMock.expect( fact.createContentValues( task ) )
   ...
   {
      final Task list = new Task( 1L, NOW, NOW, "Task", 100L, "List" );
   ...
   public void testUpdateElement_NotFound()
   {
      ...
      {
         handler.updateElement( ContentUris.TASKS_CONTENT_URI_ID,
                                new Task( 1L, NOW, NOW, "Task", 100L, "List" ),
                                new Task( 1L, NOW, NOW, "Task1", 100L, "List" ),
                                1L );
      }
      finally
      {
   ...
   public void testDeleteElement()
   {
      ...
      final String modUri = ContentUris.bindElementId( ContentUris.TASKS_CONTENT_URI_ID,
                                                       1L )
                                       .toString();
