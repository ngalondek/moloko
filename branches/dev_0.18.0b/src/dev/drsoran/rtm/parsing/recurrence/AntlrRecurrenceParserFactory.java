...
public class AntlrRecurrenceParserFactory implements IRtmRecurrenceParserFactory
{
   ...
   private Lexer createRecurrenceLexerForLocale( Locale locale, CharStream input ) throws NoSuchElementException
   {
      ...
      {
         return new dev.drsoran.rtm.parsing.grammar.antlr.recurrence.RecurrenceLexer( input );
      }
      else if ( locale == Locale.GERMAN )
      {
         return new dev.drsoran.rtm.parsing.grammar.antlr.recurrence.de.RecurrenceLexer( input );
      }
      else
      {
