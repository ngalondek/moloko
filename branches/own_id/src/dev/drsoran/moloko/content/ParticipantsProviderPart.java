...
public class ParticipantsProviderPart extends AbstractRtmProviderPart
{
   ...
   { Participants._ID, Participants.RTM_CONTACT_ID,
    Participants.RTM_TASKSERIES_ID, Participants.FULLNAME,
   ...
   public final static ContentValues getContentValues( Participant participant )
   {
      ...
      values.put( Participants.RTM_TASKSERIES_ID,
                  participant.getRtmTaskSeriesId() );
      values.put( Participants.RTM_CONTACT_ID, participant.getRtmContactId() );
                                                        ...
                                                        String rtmTaskSeriesId )
   {
      ...
      try
      {
         ...
         if ( ok )
         {
            ...
            if ( ok )
               participantsList = new ParticipantList( rtmTaskSeriesId,
                                                       participants );
         }
      }
      ...
      try
      {
         ...
         if ( ok )
         {
            ...
            if ( participantsCursor.getCount() > 0 )
            {
               ...
               {
                  contactsSelection.append( Contacts.RTM_ID )
                                   .append( "=" )
                                   .append( participantsCursor.getString( COL_INDICES.get( Participants.RTM_CONTACT_ID ) ) );
                                                     ...
                                                     String rtmContactId )
   {
      ...
      try
      {
         c = client.query( Participants.CONTENT_URI,
                           new String[]
                           { Participants._ID, Participants.RTM_CONTACT_ID },
                           Participants.RTM_CONTACT_ID + "=" + rtmContactId,
                           null,
                           null );
   ...
   {
      return new Participant( c.getLong( COL_INDICES.get( Participants._ID ) ),
                              c.getString( COL_INDICES.get( Participants.RTM_TASKSERIES_ID ) ),
                              c.getString( COL_INDICES.get( Participants.RTM_CONTACT_ID ) ),
   ...
   public void create( SQLiteDatabase db ) throws SQLException
   {
      db.execSQL( "CREATE TABLE "
         ...
         + Participants.RTM_CONTACT_ID + " TEXT NOT NULL, "
         + Participants.RTM_TASKSERIES_ID + " TEXT NOT NULL, "
         + Participants.FULLNAME + " TEXT NOT NULL, " + Participants.USERNAME
         + " TEXT NOT NULL, " + "CONSTRAINT participant FOREIGN KEY ( "
         + Participants._ID + " ) REFERENCES " + TaskSeries.PATH + " (\""
         + TaskSeries._ID + "\")" + " );" );
   }
