...
class AccountsUpdatedReceiver extends BroadcastReceiver
{
   private final IEventDrain handler;
   
   
   
   public AccountsUpdatedReceiver( IEventDrain handler )
   {
   ...
   {
      final Account rtmAccount = AppContext.get( context )
                                           .getAccountService()
                                           .getRtmAccount();
