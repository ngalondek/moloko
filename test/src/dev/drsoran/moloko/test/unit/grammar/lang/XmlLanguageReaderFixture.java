...
package dev.drsoran.moloko.test.unit.grammar.lang;
...
public class XmlLanguageReaderFixture extends MolokoTestCase
{
   ...
   {
      new XmlLanguageReader( EasyMock.createNiceMock( Language.class ),
   ...
   {
      new XmlLanguageReader( EasyMock.createNiceMock( Language.class ), null );
   }
   ...
   {
      final Language language = EasyMock.createStrictMock( Language.class );
   ...
   {
      final Language language = EasyMock.createNiceMock( Language.class );
   ...
   public void testClose()
   {
      ...
      final XmlLanguageReader reader = new XmlLanguageReader( EasyMock.createNiceMock( Language.class ),
                                                              xmlParser );
      reader.close();
   ...
   private void testAmbigiousKey( String element, Language language ) throws XmlPullParserException,
                                                                     ParseException,
                                                                     IOException
   {
      final XmlResourceParser xmlParser = EasyMock.createNiceMock( XmlResourceParser.class );
