...
public class RtmList extends RtmEntity implements
         IContentProviderSyncable< RtmList >
{
   ...
   public final static LessRtmIdComperator< RtmList > LESS_RTM_ID = new LessRtmIdComperator< RtmList >();
   ...
   public RtmList( long id, String rtmId, String name, Date created,
      Date modified, Date deleted, int locked, int archived, int position,
