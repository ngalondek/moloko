...
import dev.drsoran.moloko.content.db.Columns.Modifications;
...
class ModificationsTable extends Table
{
   ...
   public void create() throws SQLException
   {
      ...
      builder.append( " ( " );
      builder.append( Modifications._ID );
      builder.append( " INTEGER NOT NULL CONSTRAINT PK_MODIFICATIONS PRIMARY KEY AUTOINCREMENT, " );
      builder.append( Modifications.ENTITY_URI );
      builder.append( " TEXT NOT NULL, " );
      builder.append( Modifications.COL_NAME );
      builder.append( " TEXT NOT NULL, " );
      builder.append( Modifications.NEW_VALUE );
      builder.append( " TEXT, " );
      builder.append( Modifications.SYNCED_VALUE );
      builder.append( " TEXT, " );
      builder.append( Modifications.TIMESTAMP );
