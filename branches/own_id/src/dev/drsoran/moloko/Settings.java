...
public class Settings implements OnSharedPreferenceChangeListener
{
   ...
   public final static long NO_DEFAULT_LIST_ID = -1;
   ...
   private long defaultListId = NO_DEFAULT_LIST_ID;
   ...
   public void setDefaultListId( long id )
   {
      try
      {
         defaultListId = Long.parseLong( persistSetting( context.getString( R.string.key_def_list_local ),
      ...
      {
         Log.e( TAG, LogUtils.GENERIC_ERROR, e );
      }
   }
   ...
   private long setDefaultListId()
   {
      long newListId = NO_DEFAULT_LIST_ID;
      ...
      {
         if ( rtmSettings != null
            && rtmSettings.getDefaultListId() != NO_DEFAULT_LIST_ID )
         {
      ...
      else
      {
         try
         {
            newListId = Long.valueOf( preferences.getString( key,
                                                             String.valueOf( defaultListId ) ) );
         }
         catch ( NumberFormatException e )
         {
            Log.e( TAG, LogUtils.GENERIC_ERROR, e );
      ...
      if ( defaultListId != newListId )
      {
         final long oldDefListId = defaultListId;
         
         defaultListId = newListId;
         persistSetting( key, keySync, String.valueOf( defaultListId ), useRtm );
         
         return oldDefListId;
      }
      
      return NO_DEFAULT_LIST_ID;
   }
   ...
   private void loadLocalSettings()
   {
      ...
      try
      {
         defaultListId = Long.parseLong( loadLocalValue( context.getString( R.string.key_def_list_local ),
                                                         context.getString( R.string.key_def_list_sync_with_rtm ),
                                                         String.valueOf( defaultListId ) ) );
      }
      catch ( NumberFormatException e )
