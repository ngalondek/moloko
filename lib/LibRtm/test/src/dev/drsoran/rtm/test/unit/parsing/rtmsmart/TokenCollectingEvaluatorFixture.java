...
public class TokenCollectingEvaluatorFixture
{
   ...
   public void testEvalStatus()
   {
      ...
      assertToken( OP_STATUS, RtmSmartFilterSyntax.COMPLETED );
      
      evaluator.reset();
      
      assertTrue( evaluator.evalStatus( false ) );
      assertToken( OP_STATUS, RtmSmartFilterSyntax.INCOMPLETE );
   }
   ...
   public void testEvalIsTagged()
   {
      ...
      assertToken( OP_IS_TAGGED, RtmSmartFilterSyntax.TRUE );
      
      evaluator.reset();
      
      assertTrue( evaluator.evalIsTagged( false ) );
      assertToken( OP_IS_TAGGED, RtmSmartFilterSyntax.FALSE );
   }
   ...
   public void testEvalIsLocated()
   {
      ...
      assertToken( OP_IS_LOCATED, RtmSmartFilterSyntax.TRUE );
      
      evaluator.reset();
      
      assertTrue( evaluator.evalIsLocated( false ) );
      assertToken( OP_IS_LOCATED, RtmSmartFilterSyntax.FALSE );
   }
   ...
   public void testEvalIsRepeating()
   {
      ...
      assertToken( OP_IS_REPEATING, RtmSmartFilterSyntax.TRUE );
      
      evaluator.reset();
      
      assertTrue( evaluator.evalIsRepeating( false ) );
      assertToken( OP_IS_REPEATING, RtmSmartFilterSyntax.FALSE );
   }
   ...
   public void testEvalHasNotes()
   {
      ...
      assertToken( OP_HAS_NOTES, RtmSmartFilterSyntax.TRUE );
      
      evaluator.reset();
      
      assertTrue( evaluator.evalHasNotes( false ) );
      assertToken( OP_HAS_NOTES, RtmSmartFilterSyntax.FALSE );
   }
   ...
   public void testEvalIsShared()
   {
      ...
      assertToken( OP_IS_SHARED, RtmSmartFilterSyntax.TRUE );
      
      evaluator.reset();
      
      assertTrue( evaluator.evalIsShared( false ) );
      assertToken( OP_IS_SHARED, RtmSmartFilterSyntax.FALSE );
   }
