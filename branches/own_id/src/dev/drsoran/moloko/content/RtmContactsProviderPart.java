...
public class RtmContactsProviderPart extends AbstractRtmProviderPart
{
   ...
   { Contacts._ID, Contacts.RTM_ID, Contacts.FULLNAME, Contacts.USERNAME };
   ...
   public final static ContentValues getContentValues( RtmContact contact )
   {
      ...
      if ( contact != null )
      {
         ...
         values.put( Contacts.RTM_ID, contact.getRtmId() );
                                              ...
                                              String rtmId )
   {
      ...
      try
      {
         c = client.query( Contacts.CONTENT_URI, PROJECTION, Contacts.RTM_ID
            + "=" + rtmId, null, null );
   ...
   {
      return new RtmContact( c.getLong( COL_INDICES.get( Contacts._ID ) ),
                             c.getString( COL_INDICES.get( Contacts.RTM_ID ) ),
   ...
   public void create( SQLiteDatabase db ) throws SQLException
   {
      db.execSQL( "CREATE TABLE " + path + " ( " + Contacts._ID
         + " INTEGER NOT NULL AUTOINCREMENT, " + Contacts.RTM_ID
      ...
      db.execSQL( "CREATE TRIGGER " + path + "_delete_contact AFTER DELETE ON "
         ...
         + " WHERE " + Participants.RTM_CONTACT_ID + " = old."
         + Contacts.RTM_ID + "; END;" );
   }
