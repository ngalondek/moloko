...
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternBaseVisitor;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.FirstWeekdayContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.OpCountContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.OpIntervalContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.OpMonthContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.OpMonthDayContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.OpUntilContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.OpWeekdaysContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.PatternDailyContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.PatternMonthlyContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.PatternWeeklyContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.PatternYearlyContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.WeekdayContext;
import dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternParser.XStContext;
