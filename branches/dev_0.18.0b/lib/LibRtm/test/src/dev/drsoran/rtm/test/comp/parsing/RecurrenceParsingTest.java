...
import dev.drsoran.rtm.test.testdatasources.RecurrenceParserTestLanguageDe;
import dev.drsoran.rtm.test.testdatasources.RecurrenceParserTestLanguageEn;
import dev.drsoran.rtm.test.testdatasources.RecurrencePatternCollectorTestDataSource;
...
import dev.drsoran.rtm.test.testdatasources.RecurrenceTestDataSource;


@RunWith( Theories.class )
public class RecurrenceParsingTest
{
   ...
   private IRtmRecurrenceParsing recurrenceParsing;
   ...
   {
      recurrenceParsing = new RtmRecurrenceParsing( new AntlrRecurrenceParserFactory(),
                                               ...
                                               name = "recurrenceTestData" ) RecurrenceTestDataSource.TestData testData )
   {
      try
      {
         final RtmRecurrence res = recurrenceParsing.parseRecurrence( testData.sentence );
