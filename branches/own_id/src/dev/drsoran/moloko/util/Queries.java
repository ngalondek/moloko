...
{
   private final static String[] PROJECTION_ID =
   { BaseColumns._ID };
   
   private final static String[] RTM_PROJECTION_ID =
   { RtmBaseColumns.RTM_ID };
   ...
   public final static Uri contentUriWithId( Uri contentUri, long id )
   {
   ...
   {
      final Cursor c = getItem( client, RTM_PROJECTION_ID, contentUri, id );
   ...
   public final static Cursor getItem( ContentProviderClient client,
                                       ...
                                       long id ) throws RemoteException
   {
      return getItem( client, projection, contentUri, String.valueOf( id ) );
   }
