...
class RtmSettingsContentUriHandler extends AbstractContentUriHandler
{
   private final ITable rtmSettingsTable;
   
   
   
   public RtmSettingsContentUriHandler( ITable rtmSettingsTable )
   {
                                  ...
                                  String[] selectionArgs )
   {
      ...
      return rtmSettingsTable.query( projection, selection, selectionArgs, null );
   }
   ...
   {
      throw new UnsupportedOperationException( "It is not supported to have more than one RTM settings row." );
   }
   ...
   {
      return rtmSettingsTable.update( id, values, null, null );
   }
                                       ...
                                       String appendedSelection )
   {
      return new ContentProviderSelectionBuilder( contentUri,
                                                  RtmSettingsTable.TABLE_NAME ).selectElement( id )
