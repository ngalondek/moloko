...
public class Rtm
{
   ...
   public static interface RtmBaseColumns extends BaseColumns
   {
      /**
       * The unique RTM ID for an entity.
       * <P>
       * Type: STRING
       * </P>
       */
      
      public final static String RTM_ID = "rtm_id";
   }
   ...
   public static final class Lists implements RtmBaseColumns, ListColumns
   {
   ...
   protected static interface NoteColumns extends NoteBaseColumns
   {
      ...
      /**
       * The RTM ID of the taskseries referenced.
       * <P>
       * Type: TEXT
       * </P>
       */
   ...
   public static final class Notes implements RtmBaseColumns, NoteColumns
   {
   ...
   public static final class Locations implements RtmBaseColumns,
            LocationColumns
   {
   ...
   protected static interface TaskSeriesColumns
   {
      ...
      /**
       * The RTM ID of the location of this taskseries.
       * <P>
       * Type: TEXT
       * </P>
       */
      ...
      /**
       * The RTM ID of the list this taskseries is in.
       * <P>
       * Type: TEXT
       * </P>
       */
   ...
   public static final class TaskSeries implements RtmBaseColumns,
   ...
   public static final class RawTasks implements RtmBaseColumns, RawTaskColumns
   {
   ...
   protected static interface SettingsColumns
   {
      ...
      /**
       * The RTM ID of the default list the user set.
       * <P>
       * Type: TEXT, NULL if not set.
       * </P>
       */
   ...
   public static final class Contacts implements RtmBaseColumns, ContactColumns
   {
   ...
   {
      /**
       * The contact RTM ID of the contact who participates
       * <P>
       * Type: TEXT
       * </P>
       */
      ...
      /**
       * The taskseries RTM ID the contact participates in.
       * <P>
       * Type: TEXT
       * </P>
       */
