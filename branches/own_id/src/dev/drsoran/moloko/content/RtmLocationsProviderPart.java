...
public class RtmLocationsProviderPart extends AbstractRtmProviderPart
{
   ...
   { Locations._ID, Locations.RTM_ID, Locations.LOCATION_NAME,
    Locations.LONGITUDE, Locations.LATITUDE, Locations.ADDRESS,
    Locations.VIEWABLE, Locations.ZOOM };
   ...
   public final static ContentValues getContentValues( RtmLocation location )
   {
      ...
      if ( location != null )
      {
         ...
         values.put( Locations.RTM_ID, location.getRtmId() );
   ...
   {
      return new RtmLocation( c.getLong( COL_INDICES.get( Locations._ID ) ),
                              c.getString( COL_INDICES.get( Locations.RTM_ID ) ),
   ...
   public void create( SQLiteDatabase db ) throws SQLException
   {
      ...
      db.execSQL( "CREATE TABLE " + path + " ( " + Locations._ID
         + " INTEGER NOT NULL, " + Locations.RTM_ID + " TEXT NOT NULL, "
         + Locations.LOCATION_NAME + " TEXT, " + Locations.LONGITUDE
         + " REAL NOT NULL, " + Locations.LATITUDE + " REAL NOT NULL, "
         + Locations.ADDRESS + " TEXT, " + Locations.VIEWABLE
         + " INTEGER NOT NULL DEFAULT 1, " + Locations.ZOOM + " INTEGER, "
