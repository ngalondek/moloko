...
public class RtmTasksProviderPart extends AbstractRtmProviderPart
{
   ...
   { RawTasks._ID, RawTasks.RTM_ID, RawTasks.TASKSERIES_ID,
    RawTasks.RTM_TASKSERIES_ID, RawTasks.DUE_DATE, RawTasks.HAS_DUE_TIME,
   ...
   public final static ContentValues getContentValues( RtmTask task )
   {
      ...
      values.put( RawTasks.RTM_ID, task.getRtmId() );
      values.put( RawTasks.TASKSERIES_ID, task.getTaskSeriesId() );
      values.put( RawTasks.RTM_TASKSERIES_ID, task.getRtmTaskSeriesId() );
   ...
   public final static RtmTask getTask( ContentProviderClient client, String id )
   {
      ...
      try
      {
         ...
         c = client.query( RawTasks.CONTENT_URI,
                           PROJECTION,
                           new StringBuilder( RawTasks.RTM_ID ).append( "=" )
                                                               .append( id )
                                                               .append( " AND " )
                                                    ...
                                                    String taskSeriesId )
   {
      ...
      if ( !TextUtils.isEmpty( taskSeriesId ) )
      {
         ...
         try
         {
            ...
            c = client.query( RawTasks.CONTENT_URI,
                              PROJECTION,
                              new StringBuilder( RawTasks.RTM_TASKSERIES_ID ).append( "=" )
                                                                             .append( taskSeriesId )
                                                                             .append( " AND " )
                                                                             .append( RawTasks.DELETED_DATE )
                                                                             .append( " IS NULL" )
   ...
   public void create( SQLiteDatabase db ) throws SQLException
   {
      ...
      db.execSQL( "CREATE TABLE " + path + " ( " + RawTasks._ID
         + " INTEGER NOT NULL AUTOINCREMENT, " + RawTasks.RTM_ID
         + " TEXT NOT NULL, " + RawTasks.TASKSERIES_ID + " INTEGER NOT NULL, "
         + RawTasks.RTM_TASKSERIES_ID + " TEXT NOT NULL, " + RawTasks.DUE_DATE
   ...
   {
      return new RtmTask( c.getLong( COL_INDICES.get( RawTasks._ID ) ),
                          c.getString( COL_INDICES.get( RawTasks.RTM_ID ) ),
                          c.getLong( COL_INDICES.get( RawTasks.TASKSERIES_ID ) ),
                          c.getString( COL_INDICES.get( RawTasks.RTM_TASKSERIES_ID ) ),
