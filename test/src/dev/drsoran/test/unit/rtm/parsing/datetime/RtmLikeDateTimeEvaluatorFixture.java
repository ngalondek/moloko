...
package dev.drsoran.test.unit.rtm.parsing.datetime;
...
{
   private DefaultDateTimeEvaluator dateEvaluator;
   
   private RtmLikeDateTimeEvaluator evaluator;
   
   private RtmCalendar today;
   
   private RtmCalendar now;
   ...
   public void setUp() throws Exception
   {
      ...
      dateEvaluator = EasyMock.createNiceMock( DefaultDateTimeEvaluator.class );
      
      IRtmCalendarProvider calenderProvider = TestCalendarProvider.getJune_10_2010_00_00_00();
   ...
   {
      final RtmCalendar cal = now.clone();
   ...
   public void testVisitDateOnWeekday_Before()
   {
      ...
      final RtmCalendar nextWeek = cal.clone();
