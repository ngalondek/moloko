...
public interface IOnSettingsChangedListener
{
   ...
   public final static int NOTIFY_PERMAENT_TASKS = 1 << 10;
   
   public final static int NOTIFY_PERMAENT_OVERDUE_TASKS = 1 << 11;
   ...
   public final static int NOTIFY_PERMANENT_RELATED = NOTIFY_PERMAENT_TASKS
      | NOTIFY_PERMAENT_OVERDUE_TASKS;
