 ...
 */
public class RtmTask extends RtmEntity
{
   ...
   public RtmTask( long id, String rtmId, long taskSeriesId,
      String rtmTaskSeriesId, Date due, int hasDueTime, Date added,
   ...
   public RtmTask( Element elt, String rtmTaskSeriesId )
   {
      super( elt.getAttribute( "id" ) );
   ...
   public RtmTask( Element elt, String rtmTaskSeriesId, boolean deleted )
   {
      super( elt.getAttribute( "id" ) );
   ...
   public RtmTask( Parcel source )
   {
      ...
      this.taskSeriesId = source.readLong();
