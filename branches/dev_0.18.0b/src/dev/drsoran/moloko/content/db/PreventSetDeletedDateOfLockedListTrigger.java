 ...
 */
class PreventSetDeletedDateOfLockedListTrigger extends AbstractTrigger
{
   public PreventSetDeletedDateOfLockedListTrigger()
   {
      super( RtmTasksListsTable.TABLE_NAME
         + "_prevent_set_deleted_date_locked_list" );
   }
   ...
   public void create( SQLiteDatabase database ) throws SQLException
   {
      ...
      builder.append( " != 0 AND new." );
      builder.append( RtmTasksListColumns.LIST_DELETED_DATE );
      builder.append( " > 0 " );
      builder.append( "BEGIN SELECT RAISE (FAIL, 'Could not delete locked list" );
      builder.append( "'); END;" );
