...
public class OutSyncTask implements IServerSyncable< OutSyncTask, RtmTaskList >
{
            ...
            Comparator< OutSyncTask >
   {
      ...
      {
         return object1.task.getRtmId().compareTo( object2.task.getRtmId() );
      }
   }
   
   public final static LessIdComperator LESS_RTM_ID = new LessIdComperator();
                                                                            ...
                                                                            OutSyncTask serverElement )
   {
      ...
      /** RtmTaskSeries **/
      {
         ...
         if ( SyncUtils.getSyncDirection( properties,
                                          TaskSeries.RTM_LIST_ID,
                                          serverElement.taskSeries.getRtmListId(),
                                          taskSeries.getRtmListId(),
