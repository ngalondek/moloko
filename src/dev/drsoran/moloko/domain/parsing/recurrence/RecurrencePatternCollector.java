...
import static dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternLexer.COMMA;
import static dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternLexer.INT;
...
public class RecurrencePatternCollector
{
   ...
   private static TokenStream getTokenStream( String recurrencePattern )
   {
      ...
      final Lexer lexer = new dev.drsoran.moloko.grammar.antlr.recurrence.RecurrencePatternLexer( stream );
