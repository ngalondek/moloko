         ...
         IContentProviderSyncable< RtmSettings >
{
   ...
   private final String rtmDefaultListId;
   ...
   public RtmSettings( Date syncTimeStamp, String timezone, int dateFormat,
      int timeFormat, long defaultListId, String rtmDefaultListId,
      String language )
   {
      ...
      this.rtmDefaultListId = rtmDefaultListId;
   ...
   public RtmSettings( Element elt )
   {
      ...
      this.defaultListId = dev.drsoran.moloko.Settings.NO_DEFAULT_LIST_ID;
      this.rtmDefaultListId = textNullIfEmpty( child( elt, "defaultlist" ) );
   ...
   public RtmSettings( Parcel source )
   {
      ...
      this.defaultListId = source.readLong();
      this.rtmDefaultListId = source.readString();
   ...
   public String getRtmDefaultListId()
   {
      return rtmDefaultListId;
   }
   ...
   public void writeToParcel( Parcel dest, int flags )
   {
      ...
      dest.writeLong( defaultListId );
      dest.writeString( rtmDefaultListId );
   ...
   public IContentProviderSyncOperation computeContentProviderUpdateOperation( RtmSettings update )
   {
      ...
      if ( SyncUtils.hasChanged( rtmDefaultListId, update.rtmDefaultListId ) )
         result.add( ContentProviderOperation.newUpdate( settingsUri )
                                             .withValue( Settings.DEFAULTLIST_ID,
                                                         update.rtmDefaultListId )
                                             .build() );
