    ...
    implements Service
{
  ...
  public RtmTaskSeries tasks_getTask(String taskSeriesId, String taskName, String listId)
      throws ServiceException
  {
  ...
  public void tasks_setTags(String timelineId, String listId, String taskSeriesId, String taskId, String[] tags)
      throws ServiceException
  {
    ...
    invoker.invoke(new Param("method", "rtm.tasks.setTags"), new Param("timeline", timelineId), new Param("list_id", listId),
        new Param("taskseries_id", taskSeriesId), new Param("task_id", taskId), new Param("tags", stringifiedTasks.toString()),
        new Param("auth_token", currentAuthToken), new Param("api_key", applicationInfo.getApiKey()));
  }
